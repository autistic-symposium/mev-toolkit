...
#### 👾 MEV extraction can be a force of good in a non-predatory blockspace free-market as an incentive for economic security. order flow toxicity is a trader's exposure to counter-parties that possess private informational advantages - *the most valuable commodity is information*.

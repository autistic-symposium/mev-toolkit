...
* first protocol for generalized MEV at the application layer.
* rook labs maintains several API services: market making, automated trading, dapps, smart contracts, and a general-purpose RPC. 
